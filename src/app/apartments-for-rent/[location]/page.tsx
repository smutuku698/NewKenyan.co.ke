...
async function getApartmentsForRent(location: Location): Promise<PropertyListing[]> {
  let query = supabase
...
export default async function ApartmentsForRentPage({ params }: PageProps) {
  ...
  const breadcrumbItems = generateBreadcrumbs(location, 'apartments', 'rent');
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-3xl">
            {location.description || `Discover ${stats.totalCount} apartment${stats.totalCount !== 1 ? 's' : ''} for rent in ${location.name}.
            Find modern rental apartments, bedsitters, and studio flats with verified listings and landlord contacts.`}
          </p>
        </div>
