  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        'h1-mobile': ['1.875rem', { lineHeight: '1.2', letterSpacing: '-0.025em' }],
        'h1-desktop': ['2.5rem', { lineHeight: '1.1', letterSpacing: '-0.025em' }],
        'h2-mobile': ['1.5rem', { lineHeight: '1.3', letterSpacing: '-0.025em' }],
        'h2-desktop': ['2rem', { lineHeight: '1.2', letterSpacing: '-0.025em' }],
        'h3-mobile': ['1.25rem', { lineHeight: '1.4', letterSpacing: '0' }],
        'h3-desktop': ['1.5rem', { lineHeight: '1.3', letterSpacing: '0' }],
      },
      colors: {
